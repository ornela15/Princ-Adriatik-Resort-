<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Service.aspx.cs" Inherits="Service" %>
    ...
    <style>
     ...
     <div class="container">
        ...
        <div class="room">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <h3> Tiparet e dhomës</h3>
                    <p> Madhësia e dhomës: 32 m2
                        <br> Televizor me kanale të ndryshme
                        <br> Minibar i pajisur plotësisht
                        <br> Kasafortë
                        <br> Tavolinë e gjerë
                        <br> Karrige 
                        <br>Akses Interneti</p>
                </div>
                <div class="col-lg-4">
                    <h3>Çmimet e dhomave:</h3>
                    <p><br> Gjashtë dhoma: 1 krevat dopio, me pamje nga lobi, çmimi 96 €
                        <br> Tridhjetë e tetë dhoma: 1 krevat dopio, pamje nga mali, pamje anësore, me ballkon, çmimi 120 €</p>
                </div>
                <div class="col-lg-4">
